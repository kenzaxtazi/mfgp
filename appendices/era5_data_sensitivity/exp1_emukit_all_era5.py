...
import sys
dir= '/data/hpcdata/users/kenzi22' #/Users/kenzatazi/Documents/CDT/Cod
sys.path.append(dir)
...
# Get CV scheme
cv_locs = np.load( dir + '/mfgp/experiments/exp1/cv/exp1_cv_locs.npy')
...
np.save('data/cv_x_train_hf_value_2000-2005.npy', cv_x_train_hf)
np.save('data/cv_y_train_hf_value_2000-2005.npy', cv_y_train_hf)
np.save('data/cv_x_train_lf_value_2000-2005.npy', cv_x_train_lf)
np.save('data/cv_y_train_lf_value_2000-2005.npy', cv_y_train_lf)
np.save('data/cv_y_val_value_2000-2005.npy', cv_y_val)
np.save('data/cv_x_val_value_2000-2005.npy', cv_x_val)
...
cv_x_train_hf = np.load('data/cv_x_train_hf_value_2000-2005.npy', allow_pickle=True)
cv_y_train_hf = np.load('data/cv_y_train_hf_value_2000-2005.npy', allow_pickle=True)
cv_x_train_lf = np.load('data/cv_x_train_lf_value_2000-2005.npy', allow_pickle=True)
cv_y_train_lf = np.load('data/cv_y_train_lf_value_2000-2005.npy', allow_pickle=True)
cv_x_val = np.load('data/cv_x_val_value_2000-2005.npy', allow_pickle=True)
cv_y_val = np.load('data/cv_y_val_value_2000-2005.npy', allow_pickle=True)
...
np.save(dir + '/mfgp/appendices/era5_data_sensitivity/exp1_ypred_lf_all_era5_r2_2000-2005.npy', r2_low_list)
np.save(dir + '/mfgp/appendices/era5_data_sensitivity/exp1_ypred_hf_all_era5_r2_2000-2005.npy', r2_high_list)
