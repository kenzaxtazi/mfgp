...
import sys  # noqa
dir = '/data/hpcdata/users/kenzi22'  # noqa
...
for i in range(len(cv_train_list)):
    ...
    era5_df = era5.collect_ERA5('value', minyear=minyear, maxyear=maxyear)
...
np.save('/data/hpcdata/users/kenzi22/mfgp/experiments/exp0/data/cv_x_train_lf_value_all_era5_2000-2005.npy', cv_x_train_lf)
np.save('/data/hpcdata/users/kenzi22/mfgp/experiments/exp0/data/cv_y_train_lf_value_all_era5_2000-2005.npy', cv_y_train_lf)
...
np.save('/data/hpcdata/users/kenzi22/mfgp/experiments/exp0/data/lf_lambda_all_era5_2000-2005.npy', lf_lambdas)
...
cv_x_val = np.load(cv_dir + 'cv_x_val_value_all_era5_2000-2005.npy', allow_pickle=True)
cv_y_val = np.load(cv_dir + 'cv_y_val_value_all_era5_2000-2005.npy', allow_pickle=True)
lf_lambdas = np.load(cv_dir + 'lf_lambda_all_era5_2000-2005.npy', allow_pickle=True)
...
np.save(dir + '/mfgp/appendices/era5_data_sensitivity/exp0_ypred_lf_all_era5_r2_2000-2005.npy', r2_low_list)
np.save(dir + '/mfgp/appendices/era5_data_sensitivity/exp0_ypred_hf_all_era5_r2_2000-2005.npy', r2_high_list)
